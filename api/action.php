...
//resources
	//db Test1_db
		require('./resource/Test1_db/custom/CompanyCustom.php');
		require('./resource/Test1_db/Company.php');
		require('./resource/Test1_db/custom/UserCustom.php');
		require('./resource/Test1_db/User.php');
		require('./resource/Test1_db/custom/productCustom.php');
		require('./resource/Test1_db/product.php');
