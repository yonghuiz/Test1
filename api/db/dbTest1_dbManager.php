...
function getConnection() {
	...
	global $db_Test1_db_Url, $db_Test1_db_User, $db_Test1_db_Pass, $db_Test1_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Test1_db_Url.";dbname=".$db_Test1_db_DbName, $db_Test1_db_User, $db_Test1_db_Pass);
